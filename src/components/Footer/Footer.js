  ...
  return (
    <footer className={styles.footer}>
      <div className="container">
        ...
        <p className={styles.credentials}><FaCopyright /> Car<span className={styles.red}>4</span>You. All Rights Reserved. Designed By <a rel="noreferrer" target='_blank' href='https://github.com/VentsiGeorgiev'>VentsiGeorgiev</a> </p>
      </div>
    </footer>
  )
}
